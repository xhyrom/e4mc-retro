...
import dev.xhyrom.e4mc.net.legacyfabric.resourceloader.api.resource.ResourceManagerHelper;
...
public class ResourceManagerHelperImpl implements ResourceManagerHelper {
    ...
    public void sort(List<IResourceManagerReloadListener> listeners) {
        ...
        for (IResourceManagerReloadListener listener : listeners) {
